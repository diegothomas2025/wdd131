...
const temples = [
  ...
  },
  {
    ...
    area: 19000,
    imageUrl:
    "https://churchofjesuschristtemples.org/assets/img/temples/bahia-blanca-argentina-temple/bahia-blanca-argentina-temple-64758-main.jpg"
  },
  {
...
function getYear(dedicationDate) {
    return parseInt(dedicationDate.split(",")[0]);
}

document.querySelector("#old").addEventListener("click", () => {
    let oldTemples = temples.filter(temple => getYear(temple.dedicated) < 1900);
    displayTemples(oldTemples);
});

document.querySelector("#new").addEventListener("click", () => {
    let newTemples = temples.filter(temple => getYear(temple.dedicated) > 2000);
